...
Por cada tropa, elige como máximo una opción de cada par. Defender: ir a las posiciones AIV; Cavar: asignar las tropas iniciales a cavar fosos. Mantener: permanecer en un puesto defensivo; Patrullar: recorrer los puestos según los ajustes de patrulla AIC de la IA. Restablecer recupera el comportamiento del juego.
